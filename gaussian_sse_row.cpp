...
int main(int argc, char** argv) {
    cout << "Gaussian Elimination with SSE (Row-Based) Implementation" << endl;
    cout << "Current Date and Time (UTC): 2025-05-22 00:38:57" << endl;
